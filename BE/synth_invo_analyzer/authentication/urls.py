...
urlpatterns = [
    ...
    path('employee/add/', views.add_employee, name='emp-signup'),
    path('employee/signin/', views.employee_signin, name='emp-signin'),
    ...
    path('employee/protected/', views.employee_protected, name='emp_org'),
    ...
    path('supplier/pending-requests/', views.pending_requests_supplier_view, name= 'check-supplier-exists'),
    path('organization/pending-requests/', views.pending_requests_organization_view, name= 'check-supplier-exists'),
